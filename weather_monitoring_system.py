...
class WeatherStation:
    ...
    def notify_observer(self, weather_data):
    ...
    def start_monitoring(self):
        while True:  # Run indefinitely
            ...
            if weather_data != self.previous_weather_data:  # Check if the weather data has changed
                self.notify_observer(weather_data)  # Notify the observers about the updated weather data
